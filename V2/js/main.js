        ...
        { 
            ...
            intervalId = setInterval(function() { // récupère la frame actuelle de la vidéo, détecte la main et exécute la fonction du jeu
                ...
                { 
                    ...
                    {
                        getPlayerLocation(preds[0].bbox);
                    } 
                });
            }, 100); 
...
function getPlayerLocation(data)
{
	let handX = data[0] + data[2]/2; // les coordonnées récupérées correspondent au haut/gauche du carré bleu affiché autour de la main
...
function createScene(){
    ...
    /*sceneWidth=window.innerWidth;	// ******************************************************************************************* TAILLE DU CANVAS
    sceneHeight=window.innerHeight;*/
    sceneWidth=650;	// *********************************************************************************************************** TAILLE DU CANVAS
    sceneHeight=320;
